...
//for jdt logo 20260301
#elif defined(JDT_LK_LOGO)
#if defined(QVGA_JDT)
	// battery capacity rectangle
	#define CAPACITY_LEFT                (0) // battery capacity center
	#define CAPACITY_TOP                 (80)
	#define CAPACITY_RIGHT               (240)
	#define CAPACITY_BOTTOM              (240)

	// first number rectangle
	#define NUMBER_LEFT                  (0) // number
	#define NUMBER_TOP                   (80)//50
	#define NUMBER_RIGHT                 (240)
	#define NUMBER_BOTTOM                (240)//73

	// %  rectangle
	#define PERCENT_LEFT                 (0) // percent number_left + 2*number_width
	#define PERCENT_TOP                  (80)//50
	#define PERCENT_RIGHT                (240)
	#define PERCENT_BOTTOM               (240)//73

	// top animation part
	#define TOP_ANIMATION_LEFT           (0) // top animation
	#define TOP_ANIMATION_TOP            (80)//100
	#define TOP_ANIMATION_RIGHT          (240)
	#define TOP_ANIMATION_BOTTOM         (240)//113

	// for old animation
	#define BAR_LEFT            (0)
	#define BAR_TOP             (0)//96
	#define BAR_RIGHT           (0)
	#define BAR_BOTTOM          (0)//184
#endif
//for jdt logo 20260301
