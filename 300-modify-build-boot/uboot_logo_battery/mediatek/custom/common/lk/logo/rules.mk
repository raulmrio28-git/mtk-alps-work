...
ifeq ($(strip $(CUSTOM_LK_LOGO)), qvga_jdt)
RESOURCE_OBJ_LIST :=   \
            $(BOOT_LOGO_DIR)/logo.raw \
            $(BOOT_LOGO_DIR)/battery_bkg.raw \
            $(BOOT_LOGO_DIR)/battery_error.raw \
            $(BOOT_LOGO_DIR)/battery_charging_1.raw \
            $(BOOT_LOGO_DIR)/battery_charging_2.raw \
            $(BOOT_LOGO_DIR)/battery_charging_3.raw \
            $(BOOT_LOGO_DIR)/battery_charging_4.raw \
            $(BOOT_LOGO_DIR)/battery_charging_5.raw \
			$(BOOT_LOGO_DIR)/battery_full.raw
else
RESOURCE_OBJ_LIST :=   \
