...
CUSTOM_BUILD_VERNO=WD410_ASG_V002_260222 #WD410_ASG_V002_260221 #WD410_ASG_V001_251115
...
CUSTOM_HAL_IMGSENSOR=gc2145_yuv
...
CUSTOM_HAL_MAIN_IMGSENSOR=gc2145_yuv
...
CUSTOM_KERNEL_IMGSENSOR= #debug gc2145_yuv    
...
CUSTOM_KERNEL_MAIN_IMGSENSOR= #debug gc2145_yuv
...
CUSTOM_LK_LCM=st7789_qvga_longxin
CUSTOM_LK_LOGO=qvga_jdt
...
# wd410 project is no calendar importer 20251115
...
# wd410 is no mtk data transfer 20251115
...
# Preload 3rd party app - DeNA.
#wd410 must not mobage for WW project 20260302
...
#wd410 must internal fm anteena 20251115
...
MTK_FSCK_TUNE=no
#wd410 must no mtk fwupdate 20251115
MTK_FW_UPGRADE=no
#wd410 must no mtk fwupdate 20251115
...
MTK_ION_SUPPORT=yes
#wd410 must not intsant poweron 20251115
MTK_IPOH_SUPPORT=no
#wd410 must not intsant poweron 20251115
...
#wd410 must not livewallpaper 20251115
...
#wd410 must not numberlocation 20251115
...
#wd410 must not antitheft 20251115
...
MTK_PRODUCT_AAPT_CONFIG=mdpi ldpi -sw600dp -sw720dp
...
#wd410 must not qq for WW project 20251115
...
#wd410 RILD read IMSI WW project 20251115
...
# wd410 must not weibo for WW project 20251115
...
# wd410 must not tencent for WW project 20251115
...
# wd410 must not weather yet 20251115
...
# wd410 no operator for WW project 20251115
...
# wd410 udisk 20251116
#wd410 banyan add fp setting overlay 20260221
#RESOURCE_OVERLAY_SUPPORT=navbar otg LCA_ram LCA_rom
RESOURCE_OVERLAY_SUPPORT=otg LCA_ram LCA_rom fp_setting
#wd410 banyan add fp setting overlay 20260221
# wd410 udisk 20251116
...
# CUSTOM_MODEM=hexing72_cwet_kk_hspa
CUSTOM_MODEM=wd411
...
CUSTOM_KERNEL_LCM=st7789_qvga_longxin

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=st7789_qvga_longxin
...
MTK_PRODUCT_LOCALES=en_US es_ES zh_CN zh_TW ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG ro_RO pl_PL th_TH hdpi -sw600dp -sw720dp
...
# xwj WD410项目已配置以下内容：
# ISINK0, ISINK1 = KPLED
# ISINK2、ISINK3 = LEDK0+LEDK1、LEDK2+LEDK3
ASG_BL_ISINK0_1_FOR_KPLED=no
ASG_BL_ISINK2_3_FOR_ILI9341_QVGA_XRD=no
ASG_BL_FOR_WD411=yes
#========================Android===========================
#fp6572 configure 20260222
FP6572_FEATUREPHONE_CFG=yes
#fp6572 configure 20260222
#jdt customer audio 20260223
JDT_CUSTOMER_AUDIO_RING_VOL_GENERAL = 7
JDT_CUSTOMER_AUDIO_MESSAGE_VOL_GENERAL =7
JDT_CUSTOMER_AUDIO_ALARM_VOL_GENERAL = 10
JDT_CUSTOMER_AUDIO_KEY_SOUND = yes
JDT_CUSTOMER_AUDIO_VIBRA_SOUND = no
JDT_CUSTOMER_AUDIO = yes
JDT_PRODUCT = WD411
JDT_SONIVOX_NO_REVERB = yes
#jdt customer audio 20260223

#jdt wica logo 20260228
JDT_ANDROID_LOGO_WCI=yes
#jdt wica logo 20260228